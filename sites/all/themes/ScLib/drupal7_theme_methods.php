...
$art_style = '';
$art_head = '';
function ScLib_process_html(&$variables) {
...
function ScLib_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function ScLib_button($variables) {
 ...
 */
function ScLib_preprocess_page(&$vars) {
  global $art_style, $art_head;
  ...
  if (function_exists('views_get_page_view')) {
	...
	$vars['is_views'] = isset($views_page);
  }
}
 ...
 * @ingroup themeable
 */
function ScLib_menu_local_task($variables) {
 ...
 */
function ScLib_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function ScLib_node_preview($variables) {
  $node = $variables['node'];
...
*/
function ScLib_form_alter(&$form, &$form_state, $form_id) {
