...
<h1 class="art-headline" data-left="31.54%"><a href="<?php echo check_url($front_page); ?>" title = "<?php echo $site_name; ?>"><?php echo $site_name;  ?></a></h1><?php endif; ?>

<?php if (!empty($site_slogan)) : ?>
<h2 class="art-slogan" data-left="48.37%"><?php echo $site_slogan; ?>
</h2><?php endif; ?>
...
<article class="art-post art-article">
                                ...
                                <div class="art-postcontent"><?php if (!empty($title)): print '<h1'. ($tabs ? ' class="with-tabs"' : '') .'>'. $title .'</h1>'; endif; ?>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%">
        <p style="text-align: right;"><a href="#"><img width="30" height="30" alt="" src="images/rss_32.png" style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"></a><img width="31" height="30" alt="" class="art-lightbox" src="images/blog.png"><a href="#"><img width="31" height="31" alt="" src="images/facebook_32.png" style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"></a><img width="38" height="30" alt="" class="art-lightbox" src="images/twitter_new_single.png" style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"><a href="#"><img width="31" height="31" alt="" src="images/foursquare_.png" style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"></a><img width="31" height="31" alt="" class="art-lightbox" src="images/vk.png" style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"><img width="31" height="31" alt="" class="art-lightbox" src="images/yandex.png" style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"><img width="31" height="31" alt="" class="art-lightbox" src="images/memori.png" style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"><img width="31" height="31" alt="" class="art-lightbox" src="images/podfm.png" style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"><img width="31" height="31" alt="" class="art-lightbox" src="images/youtube_circle_color.png" style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"><img width="31" height="31" alt="" class="art-lightbox" src="images/slideshare.png" style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"><span style="text-align: center;"><br></span></p>
        <p style="text-align: center;"><span style="text-align: center;">Авторские права © БНТУ. Все права защищены.</span><br></p>
    </div>
    </div>
</div>
